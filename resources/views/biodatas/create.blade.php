            ...
            <div class="col-md-12">
                <div class="card border-0 shadow-sm rounded">
                    <div class="container p-4">
                        ...
                        <form action="{{ route('biodatas.store') }}" method="POST" enctype="multipart/form-data" autocomplete="off">
                            @csrf
                            <!-- Nama -->
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-control" id="jabatan" name="jabatan" required>
                                    ...
                                    <option value="Koki Snack">Koki Snack</option>
                                </select>
                                @error('jabatan')
                                    <div class="alert alert-danger mt-2">
                                        {{ $message }}
                            ...
                            <div class="mb-3">
                                ...
                                <input type="date" class="form-control" id="lama_bekerja" name="lama_bekerja" required>
                                @error('lama_bekerja')
                                    <div class="alert alert-danger mt-2">
                                        {{ $message }}
                                    </div>
