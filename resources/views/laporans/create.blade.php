...
<head>
    ...
    <title>Add New Laporan - Cafe</title>
                    ...
                    <div class="card-body">
                        <form action="{{ route('laporans.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input type="date" class="form-control @error('tgl_laporan') is-invalid @enderror" name="tgl_laporan" value="{{ old('tgl_laporan') }}" placeholder="Masukkan Tanggal Laporan">
                            
                                <!-- error message untuk tgl_laporan -->
                                @error('tgl_laporan')
                                    <div class="alert alert-danger mt-2">
                                        {{ $message }}
                                    </div>
